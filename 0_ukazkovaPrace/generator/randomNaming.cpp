...
char getNamingMethod(){
    ...
    //cout << *next(myFiles.firstNames.begin(), 50) << endl;
...
set<string> loadFile( string path ){
    set<string> resSet;
    string line = "";
...
set<string> createCourseInstances( string charset, int num ){
    set<string> res;
    set<string> file = loadFile( "./data/courses.txt" );
...
map<string,set<string> > createPersonInstances( string charset, int num, set<string> &coursesList ){
    ...
    set<string> file = loadFile( "./data/firstNames.txt" );
    set<string> file = loadFile( "./data/lastNames.txt" );
...
map<string, map<string, set<string> > > createUniversityInstances( string charset, int num, map<string, set<string> > &personList){
    ...
    set<string> file = loadFile( "./data/universities.txt" );
